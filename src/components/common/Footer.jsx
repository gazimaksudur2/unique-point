						...
						<div className="text-center">
							...
							<div className="flex items-center justify-center space-x-2">
								...
								<a
									...
									className="text-primary-400 hover:text-primary-300 font-medium text-sm transition-colors flex items-center space-x-1"
								>
							...
							<div className="mt-2">
								<a
									...
									target="_blank"
									rel="noopener noreferrer"
									className="text-gray-400 hover:text-primary-400 text-sm transition-colors flex items-center justify-center space-x-1"
								>
									<svg
										className="w-4 h-4"
										fill="currentColor"
